<?php
/**
 * Wildebeest functions and definitions
 *
...
if ( ! function_exists( 'wildebeest_setup' ) ) :
	/**
	 ...
	 */
	function wildebeest_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Wildebeest, use a find and replace
		 * to change 'wildebeest' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'wildebeest', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'wildebeest_custom_background_args', array(
 ...
 */
function wildebeest_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'wildebeest_content_width', 640 );
}
add_action( 'after_setup_theme', 'wildebeest_content_width', 0 );
 ...
 */
function wildebeest_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wildebeest' ),
		'id'            => 'sidebar-1',
...
function wildebeest_scripts() {
	...
	wp_enqueue_script( 'wildebeest-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'wildebeest_scripts' );
